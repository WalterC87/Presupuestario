# Django settings for presupuestario project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': 'presupuestario',  # Or path to database file if using sqlite3.
...
SECRET_KEY = 't+9@s9vd^d9u1mek7q4*c_55t7z^esf)c&pyri!7s02pfxi)hl'
...
ROOT_URLCONF = 'presupuestario.urls'
...
# Declaro variables para el login de app 
